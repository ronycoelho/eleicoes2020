...
plot.save <- grid.1 / p.5 / p.4 / p.3+
  plot_layout(heights = c(2,1,1,1))+
  plot_annotation(title = "Porporção de mulheres eleitas nas Câmaras por gênero",
                  subtitle = "Considerando todas as vagas de todos os município")
```
